...
class AdapterRecyclerHome(val mActivity: Activity, val mContext: Context, val mDataSet: ArrayList<ConstructorSetCard>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun setImageIntoView(path: String, imageView: ImageView){
